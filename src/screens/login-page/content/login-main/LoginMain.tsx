...
import { OtpContent } from '@/src/screens/login-page/content/login-main/content/OtpContent';
...
import { VideoBackground } from '@/src/components/video-background/VideoBackground';
